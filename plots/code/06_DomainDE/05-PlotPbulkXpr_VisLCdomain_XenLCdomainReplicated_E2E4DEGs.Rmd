...
pdf("plots/06_SRTxferDomainDE/05-LCdomain_VisDE_replicatedE2E4gene_pbulkboxplots.pdf",height=9,width=6,onefile=TRUE)
...
pdf("plots/06_SRTxferDomainDE/05-LCdomain_VisDE_replicatedE2E4gene_pbulkboxplots_StrictSmoothing.pdf", height = 9, width = 6)
