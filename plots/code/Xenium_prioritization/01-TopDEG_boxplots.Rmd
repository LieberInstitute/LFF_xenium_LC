...
```{r}
gl <- fread("processed-data/Xenium_prioritization/01a-DEGs_byCluster_andNModels_FDR0.2_noXY_maxAbsLFC0.5.txt")

dgels <- readRDS("processed-data/11_DEanalyses/01-DGElist_per_25HDG75SVGlouv1_cluster_normFilt.RDS")

# LCNM+- dgels
nmd <- readRDS("processed-data/11_DEanalyses/01b-DGElist_per_LCNMadj_subcluster_normFilt.RDS")

dgels <- c(dgels,nmd["LC.1_NMneg"],nmd["LC.1_NMpos"])
...
pdf("plots/Xenium_prioritization/01_boxplots/APOE4carrier-non_candidates.pdf",height=(1+(2.5*length(e4pos.plt))),width=8)
...
pdf("plots/Xenium_prioritization/01_boxplots/APOE4copies_candidates.pdf",height=(1+(2.5*length(e4copies.plt))),width=8)
...
pdf("plots/Xenium_prioritization/01_boxplots/sexDE_candidates.pdf",height=(1+(2.5*length(sex.plt))),width=12)
...
pdf("plots/Xenium_prioritization/01_boxplots/ancDE_candidates.pdf",height=(1+(2.5*length(anc.plt))),width=12)
