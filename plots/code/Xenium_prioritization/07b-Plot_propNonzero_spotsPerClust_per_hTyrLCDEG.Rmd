---
title: "07b-Plot_propNonzero_spotsPerClust_per_hTyrLCDEG"
...
```{r}
clprop <- fread("processed-data/Xenium_prioritization/07b-ProportionSpots_per_clus_w_msHtyrLC_fdr20DEGs.txt")
```
...
pdf("plots/Xenium_prioritization/07b-PropClusterSpots_xpr_msLChTyrDEGs.pdf",height=4*ceiling(length(plts)/2),width=14)
...
[33] evaluate_1.0.3    glue_1.8.0        farver_2.1.2      rsconnect_1.3.3  
