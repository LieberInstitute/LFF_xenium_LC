...
```{r}
nmfpredpans <- list(Br3974=xlc[,xlc$brnum=="Br3974"],Br6538=xlc[,xlc$brnum=="Br6538"])
...
show an LC smoothing on Br5941. we'll do whatever rotation necess to match visium panels' orientation in illustrator
```{r}
