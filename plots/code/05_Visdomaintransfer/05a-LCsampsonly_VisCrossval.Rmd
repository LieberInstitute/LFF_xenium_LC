...
```{r}
nc <- readRDS("processed-data/05_LabelTransfer/05a-Crossval_LCposOnly_Vis_NMF_55to71.RDS")

png("plots/05_Visdomaintransfer/05a-LCsampsonly_VisCrossval.png",height=1000,width=700)
ggplot(nc,aes(x=k,y=value))+geom_point()
dev.off()
