...
```{r}
dualscores <- readRDS("processed-data/05_LabelTransfer/03-TestLCknnsmoothing_step2k75.RDS")
...
mcmapply(d=dualscores,n=names(dualscores),mc.cores=4,SIMPLIFY=FALSE,function(d,n){
  ...
  plts <- lapply(k2thresh,function(k){
    ...
    pdf(paste0("plots/05_Visdomaintransfer/03-VisiumLabelsTransferredTEST_smoothed_KNN_",n,"_thresh2_",k,".pdf"),height=36,width=22)
