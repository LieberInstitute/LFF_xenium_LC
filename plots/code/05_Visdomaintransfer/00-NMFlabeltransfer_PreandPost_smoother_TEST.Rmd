...
```{r}
xenprj <- readRDS("processed-data/05-VistoXen_NMFlabelxfer_tol1e8_k100_alph0.RDS")
...
pdf("plots/05_Visdomaintransfer/01a-VisiumLabelsTransferred_nosmoothing.pdf",height=36,width=22)
...
pdf("plots/05_Visdomaintransfer/01b-VisiumLabelsTransferred_smoothed_k25_100iter_defaultProps.pdf",height=36,width=22)
do.call("grid.arrange",c(plts,ncol=4))
dev.off()
```
