---
title: "Plot NMF-projected LC labels w histology"
...
nmfpred <- fread("processed-data/05_LabelTransfer/06-LCsmoothings_LUT.txt")
nmfpred <- DataFrame(nmfpred[,.(rn,nmfpred)],row.names=nmfpred$rn)[colnames(spe),]
spe$label <- nmfpred$nmfpred

## only plot LC
spe$label[!(spe$label %in% c("LC","ACHE_SERT_LC_WM"))] <- NA
rm(nmfpred)
...
pal <- c(pal,NA)
names(pal)[3] <- NA
plt <- vis_grid_clus(spe,clustervar = "label",return_plots = T,spatial=T,is_stitched = T,image_id = "lowres",alpha = 0.425,colors = pal,point_size = 17.5)
plt <- lapply(plt,function(p){
  q <- p+guides(fill="none",color="none")
  return(q)
})

png("plots/05_Visdomaintransfer/06-TransferredLClabels_spatialPlots.png",width=3000,height=21000,res=300,units = "px")
...
─ Packages ──────────────────────────────────────────────────────────────────────────
 ...
 config                 0.3.2      2023-0630 [2] CRAN (R 4.5.0)
 cowplot                1.2.0      2025-07-07 [2] CRAN (R 4.5.0)
 crayon                 1.5.3      2024-06-20 [2] CRAN (R 4.5.0)
 curl                   7.0.0      2025-0619 [2] CRAN (R 4.5.0)
 ...
 evaluate               1.0.5      2025-0627 [2] CRAN (R 4.5.0)
 ...
 golem                  0.5.1      2024-0627 [2] CRAN (R 4.5.0)
 ...
 httr                   1.4.7      2023-0615 [2] CRAN (R 4.5.0)
 ...
 labeling               0.4.3      2023-0629 [2] CRAN (R 4.5.0)
 ...
 Matrix                 1.7-4      2025-0628 [2] local (/Users/bmulvey/Desktop/Matrix)
 ...
 otel                   0.2.0      2025-0629 [2] CRAN (R 4.5.0)
 ...
 rprojroot              2.1.1      2025-0626 [2] CRAN (R 4.5.0)
