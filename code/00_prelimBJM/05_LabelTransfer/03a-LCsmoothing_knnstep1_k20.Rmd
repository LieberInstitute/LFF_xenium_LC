...
labxf <- readRDS("processed-data/00_prelim_procdat_BJM/05_LabelTransfer/02-VistoXen_NMFlabelxfer_tol1e8_k63_alph0.RDS")
...
saveRDS(xyspeout,"processed-data/00_prelim_procdat_BJM/05_LabelTransfer/03-LCknnsmoothing_step1k20.RDS")
```
