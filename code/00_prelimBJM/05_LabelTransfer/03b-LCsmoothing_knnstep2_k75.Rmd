...
```{r}
labxf <- readRDS("processed-data/00_prelim_procdat_BJM/05_LabelTransfer/03-LCknnsmoothing_step1k20.RDS")
...
saveRDS(perthresh2,"processed-data/00_prelim_procdat_BJM/05_LabelTransfer/03-LCknnsmoothing_step2k75.RDS")
```
