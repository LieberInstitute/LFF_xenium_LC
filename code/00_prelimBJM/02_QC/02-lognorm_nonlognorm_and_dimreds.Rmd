...
```{r}
lcx <- readRDS("processed-data/00_prelim_procdat_BJM/02_QC/01b-spe_controlOutliers_and_giantLCmarkerlessNuclei_filtered.RDS")
```
...
## save for plotting
fwrite(rastumap,"processed-data/00_prelim_procdat_BJM/02_QC/02a-genetarg-PCAUMAP_rawct_and_Corral_andCorralUMAP_w_metadata.txt.gz",sep='\t',quote=F)
...
```{r}
saveRDS(lcx,"processed-data/00_prelim_procdat_BJM/02_QC/02b-spe_filtered_genetargonly_log-and-nonlog-norms.RDS")
```
