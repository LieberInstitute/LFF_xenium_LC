---
title: "05a-NMFcrossval_WebDivsnseq20-80"
...
saveRDS(crossval, "processed-data/05_LabelTransfer/05a-Crossval_webdivSnseqNMF_20to80.RDS")

library(ggplot2)
png("plots/05_Visdomaintransfer/05a-WebdivSnseqNMF_crossval_k20to80.png", height=4,width=8, unit="in",res=300)
