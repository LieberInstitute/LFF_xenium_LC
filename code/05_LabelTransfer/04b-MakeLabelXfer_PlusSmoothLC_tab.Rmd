...
smoove <- smooves$k1thresh_0.1
smoove[,LCsmooth:=ifelse(lcpred.smooth1.k20>=0.1 & lcpred.smooth2.k75>=0.3,"LCdomain","Other")]
...
preds <- merge.data.table(preds,smoove[,.(rn,LCsmooth)],by="rn")

nrow(preds[LCsmooth=="LCdomain"&nmfpred=="LC"])/nrow(preds[nmfpred=="LC"]) # 66% of LC cells in domain
