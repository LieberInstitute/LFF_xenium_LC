---
title: "05c-NMFcrossval_WebDivsnseq65-85"
...
saveRDS(crossval, "processed-data/05_LabelTransfer/05c-Crossval_webdivSnseqNMF_65to85.RDS")

library(ggplot2)
png("plots/05_Visdomaintransfer/05c-WebdivSnseqNMF_crossval_k65to85.png", height=4,width=8, unit="in",res=300)
...
saveRDS(lcsn,"processed-data/05_LabelTransfer/WebDivLCSN_copy_for_labelxfer.RDS")
```
