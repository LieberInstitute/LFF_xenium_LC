...
saveRDS(lcx,"processed-data/02_QC/01a-spe_raw_controlOutliers_marked.RDS")
...
```{r}
saveRDS(lcx,"processed-data/02_QC/01b-spe_controlOutliers_and_giantLCmarkerlessNuclei_filtered.RDS")
```
