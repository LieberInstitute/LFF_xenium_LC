...
labxf <- readRDS("processed-data/05_LabelTransfer/05b-LCdonsonly_VistoXen_NMFlabelxfer_tol1e8_k63_alph0.RDS")
...
saveRDS(xyspeout,"processed-data/05_LabelTransfer/06a-LCknnsmoothing_step1k20.RDS")
```
