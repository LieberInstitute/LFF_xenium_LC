...
```{r}
lx <- readRDS("processed-data/99_UsingVisSensitivityDomains/01_labelTransfer/05b-LCdonsonly_VistoXen_NMFlabelxfer_tol1e8_k63_alph0.RDS")
...
lx <- rbindlist(lx)
fwrite(lx,"processed-data/99_UsingVisSensitivityDomains/01_labelTransfer/05c-LCdonsonly_labelxfer_concattab.txt",sep='\t',quote=F,row.names=F,col.names=T)
```
