---
title: "06b-LCsmoothing_knnstep2_k75"
...
```{r}
labxf <- readRDS("processed-data/99_UsingVisSensitivityDomains/01_labelTransfer/06a-LCknnsmoothing_step1k20.RDS")
...
thresh1 <- round(seq(0.05,0.3,by=0.05),2) # thresholds above 0.3 pretty much negate LC from most samples
...
saveRDS(perthresh2,"processed-data/99_UsingVisSensitivityDomains/01_labelTransfer/06b-LCknnsmoothing_step2k75.RDS")
```
