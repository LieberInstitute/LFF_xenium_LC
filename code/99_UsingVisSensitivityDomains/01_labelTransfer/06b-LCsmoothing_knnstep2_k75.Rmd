...
```{r}
labxf <- readRDS("processed-data/05_LabelTransfer/06a-LCknnsmoothing_step1k20.RDS")
...
saveRDS(perthresh2,"processed-data/05_LabelTransfer/06b-LCknnsmoothing_step2k75.RDS")
```
