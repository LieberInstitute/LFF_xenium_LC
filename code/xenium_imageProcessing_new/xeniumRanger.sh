...
#SBATCH -o logs/01_xeniumranger_NM_DAPI_%a.txt
#SBATCH -e logs/01_xeniumranger_NM_DAPI_%a.txt
#SBATCH --array=1-34%5
...
MASK=${BASE}/processed-data/xenium_imageProcessing_new/${brnum}/combined_nucmask.npy
...
mv ${OUTPATH} ${BASE}/processed-data/xenium_imageProcessing_new/xeniumRanger/
echo "**** Job ends ****"
date
