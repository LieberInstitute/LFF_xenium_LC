...
% Writes: Kmeans_labels.tif, Kmeans_masks.mat, Kmeans_cluster.mat, Kmeans_cluster.png
    ...
    baseDir = '/dcs05/lieber/marmaypag/LFF_spatialLC_LIBD4140/LFF_xenium_LC/processed-data/xenium_imageProcessing';
    outDir  = fullfile(baseDir, brnum);
    inPath  = fullfile(outDir, 'HE_registered_to_DAPI.tif');
