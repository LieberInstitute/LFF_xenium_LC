#!/bin/bash
#SBATCH --mem=40G
#SBATCH --job-name=NMseg_removeFolds
#SBATCH -c 1
#SBATCH -t 1-00:00:00
#SBATCH -o logs/NMseg_removeFolds_%a.txt
#SBATCH -e logs/NMseg_removeFolds_%a.txt
...
matlab -nodesktop -nosplash -r "NMseg_removeFolds('$brnum',$K)"
