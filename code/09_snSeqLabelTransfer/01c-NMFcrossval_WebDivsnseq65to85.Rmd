---
title: "01c-NMFcrossval_WebDivsnseq65-85"
...
crossval <- RcppML::crossValidate(logcounts(lcsn),k=seq(65,85,1),tol=1e-5,threads=11,alpha=0,verbose=T)


saveRDS(crossval, "processed-data/09_snSeqLabelTransfer/01c-Crossval_webdivSnseqNMF_65to85.RDS")

library(ggplot2)
png("plots/09_snSeqLabelTransfer/01c-WebdivSnseqNMF_crossval_k65to85.png", height=4,width=8, unit="in",res=300)
ggplot(crossval,aes(x=k,y=value))+geom_point()+scale_x_continuous(breaks=seq(65,85,5))
dev.off()

## save a copy of the sce to use for label xfer on jhpce to make sure identical
saveRDS(lcsn,"processed-data/09_snSeqLabelTransfer/WebDivLCSN_copy_for_labelxfer.RDS")
```
