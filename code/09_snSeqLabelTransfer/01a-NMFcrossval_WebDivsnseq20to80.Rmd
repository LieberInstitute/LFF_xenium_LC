---
title: "01a-NMFcrossval_WebDivsnseq20-80"
...
options(RcppML.threads=9)
options(RcppML.verbose=TRUE)
setDTthreads(1,restore_after_fork=FALSE) # prevent resource competition
crossval <- RcppML::crossValidate(logcounts(lcsn),k=seq(20,80,5),tol=1e-5,threads=9,alpha=0,verbose=T)


saveRDS(crossval, "processed-data/09_snSeqLabelTransfer/01a-Crossval_webdivSnseqNMF_20to80.RDS")

library(ggplot2)
png("plots/09_snSeqLabelTransfer/01a-WebdivSnseqNMF_crossval_k20to80.png", height=4,width=8, unit="in",res=300)
