...
lcx <- readRDS("processed-data_newseg/11_Banksy_clustering/01-staggeredCoord_spe_genetargOnly_NONlogNorm.RDS")

# get SLURM job #, i.e. row from the parameter table to use
job <- as.numeric(Sys.getenv("SLURM_ARRAY_TASK_ID"))

# get the parameter table
parms <- fread("processed-data_newseg/11_Banksy_clustering/01-BanksyParamSets.txt")
...
pcaoutpath <- paste0(
        "processed-data_newseg/11_Banksy_clustering/01-banksy_clustruns_outs/banksyPCAs/",
