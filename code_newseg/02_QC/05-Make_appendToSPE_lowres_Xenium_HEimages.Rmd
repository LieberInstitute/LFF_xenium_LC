...
## get image filepaths
brainz <- list.files("processed-data/xenium_imageProcessing_new",recursive = FALSE)
...
for (b in c(1:nrow(brainz.dt))){
    ...
    fullres.path <- paste0("processed-data/xenium_imageProcessing_new/registrations/",brainz.dt[b,dir],"_HE.png")
...
save
```{r}
saveRDS(outspe,"processed-data_newseg/02_QC/05a-spe_filtered_genetargonly_log-and-nonlog-norms_withLowresHEs_needaligning.RDS")
```
