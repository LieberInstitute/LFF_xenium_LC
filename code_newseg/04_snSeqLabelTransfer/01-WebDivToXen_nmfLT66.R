...
## use the same snseq reference made previously, no need to recreate it for the new xenium NM segs
...
## use k=66, the crossVal-checked optimal number of nmf factors for the reference data
...
saveRDS(lcsn_to_xen,"processed-data_newseg/04_snSeqLabelTransfer/01-WebDivToXen_NMFlabelxfer_tol1e8_k66_alph0.RDS")
